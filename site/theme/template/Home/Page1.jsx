...
const page1 = [
  ...
  },
  {
    ...
    link: `/docs/guide/layout${isTH ? '-th' : ''}`,
  ...
  getChildrenToRender = () => {
    ...
    return page1.map((item, i) => {
      ...
      const pointChild = [
        ...
        'point-3',
        'point-2',
      ].map((className, ii) => <i className={className} key={ii.toString()} />);
      return (
