...
class Content20 extends React.Component {
  /* replace-start */
      ...
      >
        {this.state.current === i + 1 && (
          <Row
            ...
            /* replace-end */
          >
            <GamblingCategory name="คาสิโนยอดนิยม" block="content20" columns={3} />
          </Row>
        )}
      </TabPane>
    );
...
/* replace-start-value = export default Content20 */
export default polyfill(Content20);
/* replace-end-value */
