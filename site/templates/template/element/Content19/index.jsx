...
class Content19 extends React.Component {
  /* replace-start */
      ...
      >
        {this.state.current === i + 1 && (
          <Row
            ...
            /* replace-end */
          >
            <GamblingCategory name="ยอดฮิต" block="content19" columns={3} />
          </Row>
        )}
      </TabPane>
    );
...
/* replace-start-value = export default Content19 */
export default polyfill(Content19);
/* replace-end-value */
