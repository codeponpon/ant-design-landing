...
class Content25 extends React.Component {
  /* replace-start */
      ...
      >
        {this.state.current === i + 1 && (
          <Row
            ...
            /* replace-end */
          >
            <GamblingCategory name="หวย" block="content25" columns={4} />
          </Row>
        )}
      </TabPane>
    );
...
/* replace-start-value = export default Content25 */
export default polyfill(Content25);
/* replace-end-value */
