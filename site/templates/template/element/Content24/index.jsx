...
class Content24 extends React.Component {
  /* replace-start */
      ...
      >
        {this.state.current === i + 1 && (
          <Row
            ...
            /* replace-end */
          >
            <GamblingCategory name="เกมส์ยอดนิยม" block="content24" columns={3} />
          </Row>
        )}
      </TabPane>
    );
...
/* replace-start-value = export default Content24 */
export default polyfill(Content24);
/* replace-end-value */
